...
from products.views import SearchView, ProductsListView, ProductCreateView, ProductDeleteView, ProductUpdateView, StockMovementListView,StockMovementCreateView
